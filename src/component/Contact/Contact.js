import { Email, Home, Instagram, LinkedIn, Phone, Twitter } from '@mui/icons-material';
    ...
    return (
        <Fragment>
            <div className='w-full min-h-screen relative '>
                <div className='w-full bg-secondary opacity-75 h-96 px-12 z-50'>
                    <h1 className='lg:px-32 lg:pt-28 text-5xl font-bold text-white'> Get in Touch </h1>
                    <p className='lg:px-32 text-xl pt-5 text-white opacity-50'> Lorem ipsum dolor sit amet consectetur <br /> adipisicing elit. Omnis, ipsam. </p>
                </div>
