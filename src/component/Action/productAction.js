...
export const getProduct = (currentPage = 1, price = [0, 25000], category) => async (dispatch) => {
    try {
        ...
        if (category) {
            link = `http://localhost:5000/api/v1/products?page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}`;
        }
